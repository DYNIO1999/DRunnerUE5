...
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FOnRegainXRHeadsetTracking);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnLostXRHeadsetTracking,FQuat,LastQuat);
...
public:
	...
	static FOnRegainXRHeadsetTracking RegainXRHeadsetTrackingDelegate;
